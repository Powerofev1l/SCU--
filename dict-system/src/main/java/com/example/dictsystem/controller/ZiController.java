...
//        String upload_file_dir = ClassUtils.getDefaultClassLoader().getResource("").getPath()+"static/images/"
//                +ID + "/";
//        String upload_file_dir = ResourceUtils.getURL("classpath:").getPath();
//        File upload_file_dir_file = new File(upload_file_dir);
//        if (!upload_file_dir_file.exists()) {
//            upload_file_dir_file.mkdir();
//        }

//        File path = new File("D:\\java_web\\DemoProject\\dictionary\\RunTest\\");
...
//        String parent= upload_file_dir_file.getPath();
